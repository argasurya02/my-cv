  ...
  const experiences = [
    {
      ...
      title: "OSIS SMP-SMK",
      imageSrc: osis,
      description: "Saya telah mengikuti OSIS hampir 6 tahun dari SMP-SMK yang telah memberikan saya banyak pengalaman berorganisasi",
    },
    {
      id: 2,
      title: "Pemuda Gereja",
      imageSrc: pemuda,
      description: "Saya baru saja dilantik menjadi wakil ketua pemuda di gereja, saya harap saya mampu bertahan",
    },
  ];
